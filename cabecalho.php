...
<html class="wide wow-animation" lang="en">
  <head>
    ...
    <meta name="author" content="Gustavo Rodrigues">
            ...
            <div class="rd-navbar-main-outer">
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <!-- RD Navbar Brand-->
                  <div class="rd-navbar-brand"><a class="brand" href="index.php"><img src="images/logo.png" alt="" width="196" height="47"/></a></div>
                </div>
                ...
                <div class="rd-navbar-project rd-navbar-modern-project">
                  ...
                  <div class="rd-navbar-project-content rd-navbar-modern-project-content">
                    <div>
                      <p>Siga-nos nas redes sociais e fique por dentro das promoções, participe pra ganhar prêmios e grandes descontos!!</p>
                      ...
                      <ul class="rd-navbar-modern-contacts">
                        <li>
                          <div class="unit unit-spacing-sm">
                            ...
                            <div class="unit-body"><a target="_brank" title="Ir para WhatsApp" class="link-phone" href="https://api.whatsapp.com/send?phone=5538999773004">38 999773004</a></div>
                          </div>
                        </li>
                        <li>
                          <div class="unit unit-spacing-sm">
                            <div class="unit-left"><span class="icon fa fa-location-arrow"></span></div>
                            <div class="unit-body"><a class="link-location" href="#">Rua João Oliveira Campus Nº316, Arinos Minas Gerais</a></div>
                          </div>
                        </li>
                        <li>
                          <div class="unit unit-spacing-sm">
                            <div class="unit-left"><span class="icon fa fa-envelope"></span></div>
                            <div class="unit-body"><a class="link-email" href="mailto:#">gustavorodriguesgra13@gmail.com</a></div>
                          </div>
                        </li>
                      </ul>
                      <ul class="list-inline rd-navbar-modern-list-social">
                        <li><a title="Ir para a pagina no facebook" class="icon fa fa-facebook" href="https://www.facebook.com/profile.php?id=100005223510457"></a></li>
