              ...
              <div class="col-sm-6 col-lg-4 col-xl-3">
                <div class="oh-desktop">
                  <div class="wow slideInRight" data-wow-delay="0s">
                    <div class="footer-brand"><a href="index.html"><img src="images/logo-inverse.png" alt="" width="196" height="42"/></a></div>
                    <p>Estamos a mais de 20 anos no mercado, sempre dando o melhor para nossos clientes.</p>
                    <ul class="footer-contacts d-inline-block d-md-block">
                      <li>
                        <div class="unit unit-spacing-xs">
                          <div class="unit-left"><span class="icon fa fa-phone"></span></div>
                          <div class="unit-body"><a class="link-phone" href="https://api.whatsapp.com/send?phone=5538999773004">38 999773004</a></div>
                        </div>
                      </li>
              ...
              <div class="col-sm-6 col-lg-4 col-xl-4">
                <div class="oh-desktop">
                  <div class="inset-top-18 wow slideInDown" data-wow-delay="0s">
                    <h5>Cadrastre-se</h5>
                    <p>Insira abaixo seu email para se cadastrar em nosso devilery.</p>
                    <form class="rd-form rd-mailform" data-form-output="form-output-global" data-form-type="subscribe" method="post" action="bat/rd-mailform.php">
                      ...
                      <button class="button button-block button-white" type="submit">Inscreve-se</button>
                    </form>
                    ...
                    <div class="row row-10 gutters-10" data-lightgallery="group">
                      ...
                      <div class="col-6 col-sm-3 col-lg-6">
                        ...
                        <article class="thumbnail thumbnail-mary">
                          ...
                          <div class="thumbnail-mary-caption"><a class="icon fl-bigmug-line-zoom60" href="images/galeria-loja/04.jpg" data-lightgallery="item"><img src="images/galeria-loja/04.jpg" alt="" width="129" height="120"/></a>
                          </div>
                        </article>
                      </div>
                    </div>
